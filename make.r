...
colors = c(
  ...
  "Centro Democratico" = "#FDB462", # Camera 16-17 only, centre-left, light orange
  "Unione di Centro" = "#80B1D3", # light blue
  "Popolari-UDEUR" = "#8DD3C7", # teal, Camera 13-15 only
  "Scelta Civica con Monti" = "#053061", # Monti, both chambers (16-17) but small in Senate, dark blue
